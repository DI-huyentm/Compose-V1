...
function StudentsPage() {
  ...
  return (
    <div style={{ backgroundColor: lightGray, padding: '20px', margin: '0 auto', maxWidth: '1000px', overflowY: 'auto' }}>
      ...
      <Table style={{ border: `1px solid ${gray}` }}>
        <TableHead style={{ backgroundColor: green, color: white }}>
          <TableRow>
            <TableCell style={{ border: `1px solid ${gray}`, fontWeight: 'bold' }}>ID</TableCell>
        ...
        <TableBody>
          {students.map(student => (
            <TableRow key={student.id}>
              <TableCell style={{ border: `1px solid ${gray}` }}>{student.id}</TableCell>
